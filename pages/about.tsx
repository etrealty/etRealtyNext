  ...
  return (
   <div>
    ...
    <div style={{minHeight: '200%' ,textAlign: 'center'}}>
      <h1>About Page</h1>
      <img height={300} width={200} style={{boxShadow: 'grey 8px 8px 2px 2px', borderRadius: '16px'}} src="https://res.cloudinary.com/dq6yyefdy/image/upload/v1676740978/homeland_reality-20_cvjkez.jpg" alt="realty team" />
      <div style={{boxShadow: 'grey 8px 8px 2px 2px',border: '2px solid black',borderRadius: '20px',margin: '40px',background: '#6f8e70'}}>
